...
// === COMMON/ADAPTED STYLES ===
    ...
    // Build the Debug
    strNotificationMessage = MODULE_AUTHOR + " " + MODULE_CONSOLE_COMMON_PIPE + " " + MODULE.NAME + ": " + strMessage + " | " + strResult;
    if (blnDivider) {
    ...
    if (blnDebug == true) {
        ...
        if (COFFEEPUB.blnDebugOn) {
            ...
            if (COFFEEPUB.blnFancyConsole) {
                ...
                if (COFFEEPUB.strConsoleDebugStyle == "fancy") {
                    // FANCY STYLE
                    // BUILD Content
                    strConsoleMessage = "%c" + MODULE_CONSOLE_COMMON_ICON_BUG + " " + MODULE_AUTHOR + " " + MODULE_CONSOLE_COMMON_PIPE  + " " + MODULE.NAME + " DEBUG" + strMessageFlag + strMessage + strResultFlag;
                    // PUBLISH with Styles
                    ...
                    // SIMPLE STYLE
                    // BUILD Content
                    strConsoleMessage = "%c" + MODULE_CONSOLE_COMMON_ICON_BUG + " " + MODULE_AUTHOR + "%c" + MODULE_CONSOLE_COMMON_PIPE + "%c" + MODULE.NAME  + " DEBUG" + strMessageFlag + strMessage + strResultFlag;
                    // PUBLISH with Styles
                    ...
                    // PLAIN STYLE
                    strConsoleMessage =  "%c" + MODULE_AUTHOR + " " + MODULE_CONSOLE_COMMON_PIPE + " %c" + MODULE.NAME + " DEBUG: %c" + strMessage;
                ...
                strConsoleMessage = MODULE_AUTHOR + " " + MODULE_CONSOLE_COMMON_PIPE + " " + MODULE.NAME + " DEBUG: " + strMessage;
        ...
        if (COFFEEPUB.blnFancyConsole) {
            strConsoleMessage = "%c" + MODULE_AUTHOR + "%c" + MODULE_CONSOLE_COMMON_PIPE + "%c" + MODULE.NAME + "%c" + strMessage;
            ...
            strConsoleMessage = MODULE_AUTHOR + " " + MODULE_CONSOLE_COMMON_PIPE + " " + MODULE.NAME + ": " + strMessage;
            console.info(strConsoleMessage, strResult);
        }
        if (blnNotification){
